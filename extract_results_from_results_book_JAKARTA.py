...
#OSijek, Baku bonus and penalties inverted (Osijek) or always penalty (Baku, Cairo)
#having a score checker (D_E+B-P=Final would be nice)
#Antalya no bonuses showing up - Ş special character in name error
#antalya - U avec trema (Ü) and G with upside down hat (Ğ), (Ö)ss
#might need to see if the csv file is saving with correct character allowables
#Antalya data on pommel is bad QF
#Antalya vault is actually really close
...
Doha_dict = {"QF":{"FX":[17],"PH":[18],"SR":[19],"VT":[20],"PB":[21],"HB":[22]},
             "EF":{"FX":[30],"PH":[31],"SR":[32],"VT":[34],"PB":[34],"HB":[35]},
                }
...
for comp in competitions:
    ...
    print("=============")
    file_path = f"{folder_path}/{comp}_RESULTS.pdf"
